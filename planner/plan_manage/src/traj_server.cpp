...
void publish_cmd(Vector3d p, Vector3d v, Vector3d a, Vector3d j, double y, double yd)
{
  ...
  px4_cmd.acceleration_or_force.x = a(0);
  px4_cmd.acceleration_or_force.y = a(1);
  px4_cmd.acceleration_or_force.z = a(2);
  px4_cmd.yaw = y;
  px4_cmd.yaw_rate = yd;
...
int main(int argc, char **argv)
{
  ...
  px4_pos_cmd_pub = nh.advertise<mavros_msgs::PositionTarget>("/mavros/setpoint_raw/local", 50);
